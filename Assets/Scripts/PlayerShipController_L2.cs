...
public class PlayerShipController_L2 : MonoBehaviour
{
    public float speed;
    ...
    public bool allowYMovement = true;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space))
        {
            ...
            GameObject playerBullet2 = Instantiate(PlayerBullet);
            playerBullet.transform.position = new Vector3(transform.position.x-0.3f, transform.position.y + 0.1f,90);
            playerBullet2.transform.position = new Vector3(transform.position.x+0.3f, transform.position.y + 0.1f,90);
        }
    ...
    private void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        if (collider.tag.Equals("enemies") || collider.tag.Equals("enemyBullet"))
        {
            ...
            if (!isShield)
            {
                ...
                int lifes = GameObject.Find("PlayerLifeLevelTwo").GetComponent<PlayerLife>().PlayerLifes;
                if (lifes == 1)
                {
                    Debug.Log("GameOver");
                    GameObject.Find("PlayerLifeLevelTwo").GetComponent<PlayerLife>().DestroyLife();
                    this.LossThisLevel();
                }
                else
                {
    ...
    {
        GameObject.Find("OpenLeftLevelTwo").GetComponent<LevelTwoOpeningWall>().EndingEvent();
        GameObject.Find("OpenRightLevelTwo").GetComponent<LevelTwoOpeningWall>().EndingEvent();
